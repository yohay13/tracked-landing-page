...
import { initWeaver, track as weaverTrack, identify as weaverIdentify, page as weaverPage } from '@yohay13/weaver-sdk';
...
class Analytics {
  ...
  init(token: string): void {
    ...
    // weaver.init(token); // Weaver doesn't have an init method like Mixpanel
